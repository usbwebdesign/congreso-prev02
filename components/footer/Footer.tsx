...
export default function Footer() {
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, id: string) => {
    // Si estamos en la página principal, prevenimos la recarga y hacemos scroll suave directo
        ...
        <div className={s.topSection}>
          ...
          <div className={s.brandSection}>
            <div className={s.logos}>
              {/* Logo Universidad Simón Bolívar */}
              <a 
                href="https://www.usb.edu.mx/" 
                target="_blank" 
          ...
          {/* Navegación del Congreso con Rutas Absolutas */}
          <nav className={s.nav}>
            <ul className={s.navList}>
              <li>
                <Link href="/#inicio" onClick={(e) => handleNavClick(e, 'inicio')}>Inicio</Link>
              </li>
              <li>
                <Link href="/#evento" onClick={(e) => handleNavClick(e, 'evento')}>Evento</Link>
              </li>
              <li>
                <Link href="/#ponentes" onClick={(e) => handleNavClick(e, 'ponentes')}>Ponentes</Link>
              </li>
              <li>
                <Link href="/#agenda" onClick={(e) => handleNavClick(e, 'agenda')}>Agenda</Link>
              </li>

              {!loading && user && (
                <li>
                  <Link href="/#conferencias" onClick={(e) => handleNavClick(e, 'conferencias')}>Conferencias</Link>
                </li>
              )}
              
              {!loading && !user && (
                <li>
                  <Link href="/#acceso" onClick={(e) => handleNavClick(e, 'acceso')}>Acceso</Link>
                </li>
              )}
            </ul>
          </nav>
